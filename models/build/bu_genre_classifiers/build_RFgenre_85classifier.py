...
train = train_df[~train_df['genre_parse'].isin([4, 5, 6,  8])]
...
conf_m = confusion_matrix(Y_RF_test, Y_pred)
ConfusionMatrixDisplay(confusion_matrix=conf_m, display_labels=["jazz","electronic", "folk/country",  "classical/baroque"]).plot()
...
dump(genre_RF_classifier, 'RF_85genre.joblib')
